...
// Id тестового пользователя, засеянного вручную в БД (см. seed-test-user.sql в корне репозитория).
// Настоящей регистрации в API пока нет — когда появится, это заменится на id из сессии.
